...
**Latest Version:** `3.1.1` | **Python:** 3.11 (Bookworm), 3.13 (Trixie) | [View on piwheels](https://www.piwheels.org/project/omnipkg/)
```bash
pip3 install omnipkg==3.1.1
```
**Verified Platforms:**
- 🍓 Raspberry Pi (armv6/armv7) - Bullseye, Bookworm, Trixie
- 📦 Wheel: [`https://www.piwheels.org/simple/omnipkg/omnipkg-3.1.1-cp311-cp311-linux_armv7l.whl`](https://www.piwheels.org/simple/omnipkg/omnipkg-3.1.1-cp311-cp311-linux_armv7l.whl)
<!-- PIWHEELS_STATS_END -->
