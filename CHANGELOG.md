...
.github/workflows/conda_build.yml                 |  820 ++--
 ...
 src/tests/test_swap_install.py                    |    4 +-
 src/tests/test_version_combos.py                  |    2 +-
 78 files changed, 7018 insertions(+), 3569 deletions(-)
```
...
.github/workflows/conda_build.yml                 |  820 ++--
 ...
 src/tests/test_swap_install.py                    |    4 +-
 src/tests/test_version_combos.py                  |    2 +-
 78 files changed, 7098 insertions(+), 3569 deletions(-)
```
...
.github/workflows/conda_build.yml                 |  820 ++--
 ...
 src/tests/test_swap_install.py                    |    4 +-
 src/tests/test_version_combos.py                  |    2 +-
 78 files changed, 7224 insertions(+), 3569 deletions(-)
```
...
.github/workflows/conda_build.yml                 |  820 ++--
 ...
 src/tests/test_swap_install.py                    |    4 +-
 src/tests/test_version_combos.py                  |    2 +-
 78 files changed, 7351 insertions(+), 3569 deletions(-)
```
...
.github/workflows/conda_build.yml                 |  820 ++--
 ...
 src/tests/test_swap_install.py                    |    4 +-
 src/tests/test_version_combos.py                  |    2 +-
 78 files changed, 7479 insertions(+), 3569 deletions(-)
```
...
.github/workflows/conda_build.yml                 |  820 ++--
 ...
 src/tests/test_swap_install.py                    |    4 +-
 src/tests/test_version_combos.py                  |    2 +-
 78 files changed, 7608 insertions(+), 3569 deletions(-)
```
...
.github/workflows/conda_build.yml                 |  820 ++--
 ...
 src/tests/test_swap_install.py                    |    4 +-
 src/tests/test_version_combos.py                  |    2 +-
 78 files changed, 7738 insertions(+), 3569 deletions(-)
```
...
.github/workflows/conda_build.yml                 |  820 ++--
 ...
 src/tests/test_swap_install.py                    |    4 +-
 src/tests/test_version_combos.py                  |    2 +-
 78 files changed, 7869 insertions(+), 3569 deletions(-)
```
...
.github/workflows/conda_build.yml                 |  820 ++---
 ...
 src/omnipkg/locale/it/LC_MESSAGES/omnipkg.po      |    2 +-
 src/omnipkg/locale/ja/LC_MESSAGES/omnipkg.mo      |  Bin 38713 -> 38886 bytes
 src/omnipkg/locale/ja/LC_MESSAGES/omnipkg.po      | 3857 ++++++++++++++++++++-
 src/omnipkg/locale/ko/LC_MESSAGES/omnipkg.mo      |  Bin 35864 -> 35489 bytes
 src/omnipkg/locale/ko/LC_MESSAGES/omnipkg.po      |   10 +-
 src/omnipkg/locale/nl/LC_MESSAGES/omnipkg.mo      |  Bin 34128 -> 33773 bytes
 src/omnipkg/locale/nl/LC_MESSAGES/omnipkg.po      |   10 +-
 ...
 src/tests/test_swap_install.py                    |    4 +-
 src/tests/test_version_combos.py                  |    2 +-
 77 files changed, 7585 insertions(+), 2413 deletions(-)
```
