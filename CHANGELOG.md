...
- cli/daemon: add restart command; simplify startup logic; harden Windows daemon launch
...
.github/workflows/conda_build.yml                 |  820 ++--
 ...
 src/omnipkg/isolation/resource_monitor.py         |  148 +-
 src/omnipkg/isolation/worker_daemon.py            |  163 +-
 ...
 src/omnipkg/locale/ja/LC_MESSAGES/omnipkg.mo      |  Bin 38713 -> 38886 bytes
 src/omnipkg/locale/ja/LC_MESSAGES/omnipkg.po      | 5008 ++++++++++++++++-----
 ...
 src/tests/test_concurrent_install.py              |   71 +-
 src/tests/test_flask_port_finder.py               |    3 +-
 src/tests/test_flask_port_finder_universal.py     |   30 +-
 src/tests/test_loader_stress_test.py              |  111 +-
 src/tests/test_multiverse_healing.py              |    6 +-
 src/tests/test_old_flask.py                       |    2 +-
 src/tests/test_old_rich.py                        |    6 +-
 src/tests/test_rich_switching.py                  |   33 +-
 src/tests/test_swap_install.py                    |    4 +-
 src/tests/test_version_combos.py                  |    2 +-
 76 files changed, 6848 insertions(+), 3567 deletions(-)
```

## [2.2.2] - 2026-02-13

### 🚀 Features
- Merge development into main (71aa183c)
- feat: daemon idle worker management and i18n updates (90700e5c)
- Update windows-concurrency-test.yml (49eec6b2)
- Update windows-concurrency-test.yml (68072d47)
- Update windows-concurrency-test.yml (a3c3706b)
- Update windows-concurrency-test.yml (e33e8353)
- cli/daemon: add restart command; simplify startup logic; harden Windows daemon launch (f736c2e6)
- Merge development into main, keeping development changes for conflicts (714c9ee0)
- refactor: remove undefined name from `__all__` (35d7a076)
- Merge pull request #72 from 1minds3t/deepsource-autofix-17292d1c (51ad2ddc)
- refactor: remove reimported module (e2655649)
- Sync main → development (auto-merge conflict fixes) (a60de013)
- Merge pull request #71 from 1minds3t/deepsource-autofix-4da6df26 (f8f03f45)
- refactor: remove unnecessary return statement (a92bf0d5)
- Sync main → development after auto-merge (a371dfcc)
- fix(cli): hoist i18n imports to global scope to prevent UnboundLocalError (09a2feba)
- feat(i18n): Integrate and propagate i18n across core components (097928f7)
- Update README.md (b56a8f47)
- Update README.md (667bb60d)
- Update README.md (fbb98479)
- Update publish.yml (dbc8e9b7)
- Update publish.yml (f42c15cc)
- Update README.md (781ac4e6)
- Update publish.yml (d3a35690)
- Update publish.yml (a14480a5)
- Update conda_build.yml (67929087)
- Update conda_build.yml (fe9b2dac)
- Update conda_build.yml (d2c5cfc3)
- Update meta-platforms.yaml (4155fdd3)
- Update meta-noarch.yaml (f2b06cad)
- Update meta-platforms.yaml (12d541de)
- Update publish.yml (0e1b84ac)
- Update publish.yml (91782e7a)
- Update conda_build.yml (b67d61ac)
- Update conda_build.yml (8d8d2b4d)
